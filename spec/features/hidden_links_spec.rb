...
feature "hidden links" do
	...
	context "regular users" do
		...
		scenario "New ticket link si hidden from a user without permission" do
			define_permission!(user, "view", project)
			visit project_path(project)
		...
		scenario "Delete tickte link is shown to a user with permission" do
			ticket
			define_permission!(user, "view", project)
		...
		scenario "Delete ticket link is hidden form users without permission" do
			ticket
			define_permission!(user, "view", project)
			visit project_path(project)
			click_link ticket.title
